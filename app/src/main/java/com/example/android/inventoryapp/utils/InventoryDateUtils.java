...
/**
 * Created by Marcin on 2017-07-26.
 */

public class InventoryDateUtils {
    ...
    private static String getDayName(Context context, long dateInMillis) {
        ...
        switch (daysAfterToday) {
            case 0:
                return context.getString(Integer.parseInt("today"));
            case 1:
                return context.getString(Integer.parseInt("tomorrow"));
